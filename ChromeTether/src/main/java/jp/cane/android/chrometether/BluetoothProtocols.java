...
public class BluetoothProtocols {
    ...
    final public static UUID DUN2 = UUID
            .fromString("00002A0B-0000-1000-8000-00805F9B34FB");
    final public static UUID DUN3 = UUID
            .fromString("A5352A0B-A1F1-4456-8847-C6AB99E824F6");
    ...
    /**
     * DialUp Network 0x1103 16-bit
     */
    public static final UUID DIAL_UP_NETWORK_UUID = fromUUID16(0x1103);
    /**
